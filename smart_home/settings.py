...
SECRET_KEY = 'django-insecure-6_^y=)cq$72s(gd8o86q3!a5$eu)*-1r%=c##7b_mo+32lc)on'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['auto-house.liara.run', '127.0.0.1']

LOGIN_URL = 'accounts:user_signin'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Add your additional static files directories here
]
